            ...
            let parcels = this.parcels
                ...
                if (parcel.place != this.place) {
                    if (parcel.place === destination) {
                        console.log(`Will be picking up a parcel from: ${parcel.place} to: ${parcel.address}`);
                    }
                    else {
                        console.log(`Still need to deliver a parcel from: ${parcel.place} to: ${parcel.address}`);
                    }
                    return parcel;
                }
                // Add parcels to the array that are picked up at the current location
                console.log(`Updating a parcel to be from: ${destination} to: ${parcel.address}`);
                ...
                if (parcel.place === parcel.address) {
                    console.log(`***** Delivered a parcel from: ${parcel.place} to: ${parcel.address}`);
                }
